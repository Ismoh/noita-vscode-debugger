...
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --lua-version="5.1" --local lua_dir %2\.build\LuaJIT-2.1.0-beta3

echo "----------------------------------------------------------------------------------------------------------------------"
echo "Init LuaRocks project"
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe --lua-version="5.1" init noita-vscode-debugger --output="%2\mods\noita-vscode-debugger" --homepage="https://github.com/Ismoh/noita-vscode-debugger" --license="MIT"
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_DIR %2\.build\LuaJIT-2.1.0-beta3
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_BINDIR %2\.build\LuaJIT-2.1.0-beta3\bin
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_INCDIR %2\.build\LuaJIT-2.1.0-beta3\include
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_LIBDIR %2\.build\LuaJIT-2.1.0-beta3\lib
