...
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --lua-version="5.1" --local lua_dir %2\LuaJIT-2.1.0-beta3
...
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_DIR %2\LuaJIT-2.1.0-beta3
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_BINDIR %2\LuaJIT-2.1.0-beta3\bin
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_INCDIR %2\LuaJIT-2.1.0-beta3\include
%2\.build\luarocks-3.9.2-windows-32\luarocks.exe config --scope project variables.LUA_LIBDIR %2\LuaJIT-2.1.0-beta3\lib
